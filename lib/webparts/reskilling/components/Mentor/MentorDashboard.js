...
var MentorDashboard = function (_a) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        PARTICIPANTS_LIST = Config.LIST_NAMES.PARTICIPANTS;
    ...
    if (loading) {
        return React.createElement("div", null, "Loading participants...");
    }
    return (React.createElement("div", null,
        React.createElement("h1", null, "Mentor Dashboard"),
        React.createElement("h2", null, "Your Assigned Participants"),
        participants.length === 0 ? (React.createElement("p", null, "You have no assigned participants.")) : (React.createElement("ul", null, participants.map(function (participant) { return (React.createElement("li", { key: participant.Id },
            participant.Title,
            " - ",
            participant.Status)); })))));
};
export default MentorDashboard;
//# sourceMappingURL=MentorDashboard.js.map