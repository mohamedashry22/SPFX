...
var ProgramList = function (_a) {
    ...
    return (React.createElement("div", null,
        React.createElement("h2", null, "Programs"),
        React.createElement("ul", null, programs.map(function (program) { return (React.createElement("li", { key: program.Id },
            React.createElement("div", { onClick: function () { return handleProgramClick(program.Id); }, style: { cursor: 'pointer', color: 'blue' } }, program.Title),
            ' - ',
